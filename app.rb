...
get '/shelf' do
  ...
  groups_list = s3.list_objects(bucket: "aweshinbookshelf").common_prefixes
  @books_list = groups_list.flat_map{ |key|
    s3.list_objects(bucket: "aweshinbookshelf", prefix: "#{key}/", delimiter: '/')
  }
