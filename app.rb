...
get '/shelf' do
  ...
  @books_list = groups_list.common_prefixes.flat_map{ |object|
    s3.list_objects(bucket: "aweshinbookshelf", prefix: "#{object.prefix}", delimiter: '/').common_prefixes.map{ |title| title.prefix }
  }
